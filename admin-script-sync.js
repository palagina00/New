...
// URL для GitHub API
const ADMIN_GITHUB_API_URL = 'https://api.github.com/repos/palagina00/1/contents/data.json';
const ADMIN_GITHUB_RAW_URL = 'https://raw.githubusercontent.com/palagina00/1/main/data.json';
